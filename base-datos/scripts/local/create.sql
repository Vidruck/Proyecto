...
CREATE TABLE tce07_bloque_cita (id_bloque SERIAL NOT NULL, fk_id_sucursal int4 NOT NULL, fk_id_cita int4, fh_inicio timestamp NOT NULL, fh_fin timestamp NOT NULL,PRIMARY KEY (id_bloque));
